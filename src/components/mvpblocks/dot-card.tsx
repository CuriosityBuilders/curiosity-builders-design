      ...
      <div className="relative w-full border-x border-zinc-400">
        <div className="absolute z-0 grid h-full w-full items-center">
          <section className="absolute z-0 grid h-full w-full grid-cols-2 place-content-between">
            <div className="bg-black my-4 size-1 -translate-x-[2.5px] rounded-full outline outline-8 outline-white sm:my-6 md:my-8" />
            <div className="bg-black my-4 size-1 translate-x-[2.5px] place-self-end rounded-full outline outline-8 outline-white sm:my-6 md:my-8" />
            <div className="bg-black my-4 size-1 -translate-x-[2.5px] rounded-full outline outline-8 outline-white sm:my-6 md:my-8" />
            <div className="bg-black my-4 size-1 translate-x-[2.5px] place-self-end rounded-full outline outline-8 outline-white sm:my-6 md:my-8" />
          </section>
        </div>
